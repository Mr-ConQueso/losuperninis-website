<script lang="ts">
	...
	import LicencesContentEN from '$lib/components/legal/licences/LicencesContentEN.svelte';
	import LicencesContentES from '$lib/components/legal/licences/LicencesContentES.svelte';
