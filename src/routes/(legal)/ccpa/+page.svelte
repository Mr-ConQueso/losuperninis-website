...
<div class="privacy-policy-container container">
	...
	<p id="date"><strong>
			Last modified: <time datetime="05-10-25">05/10/25</time>
	</strong></p>
	<p>This Privacy Notice for California Residents supplements the information contained in the Privacy Policy of {COMPANY_NAME} (the <strong>"Company"</strong>, <strong>"us"</strong>, <strong>"we"</strong>, <strong>"our"</strong>). and applies solely to all visitors, users, and others who reside in the State of California (<strong>"consumers"</strong> or <strong>"you"</strong>). We adopt this notice to comply with the California Consumer Privacy Act of 2018 (CCPA), as it may be amended, modified or supplemented from time to time, and any terms defined in the CCPA have the same meaning when used in this notice.</p>
	...
	<br><p>Personal information does not include:</p>
	<ol>
	...
	<br><p>We obtain the categories of personal information listed above from the following categories of sources:</p>
	<ol>
	...
	<br><p>We will not collect additional categories of personal information or use the personal information we collected for materially different, unrelated, or incompatible purposes without providing you notice.</p>
	...
	<p>To exercise the access, data portability, and deletion rights described above, please submit a verifiable consumer request to us by emailing us at contact@losuperninis.com.</p>
	...
	<p>We reserve the right to amend this privacy notice at our discretion and at any time. When we make changes to this privacy notice, we will post the updated notice on the Service and update the notice's effective date.
		<strong>Your continued use of our Service following the posting of changes constitutes your acceptance of such changes</strong>.</p>

	<h2>Contact Information</h2>
	<p>If you have any questions or comments about this notice, the ways in which we collect and use your information described below and in the
		<a href="/privacy">Privacy Policy</a>, your choices and rights regarding such use, or wish to exercise your rights under California law, please do not hesitate to contact us at
