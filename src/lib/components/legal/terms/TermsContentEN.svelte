...
<div class="terms-content">
	...
	<p>These terms of use are entered into by and between You and {t.main.title} (<strong>"Company"</strong>, <strong>"we"</strong> or <strong>"us"</strong>). The following terms and conditions, together with any documents they expressly incorporate by reference (collectively, these <strong>"Terms of Use"</strong>), govern your access to and use of <a href="{WEBSITE_URL}">{WEBSITE_URL}</a> and our Games and Applications, including any content, functionality and services offered on or through <a href="{WEBSITE_URL}">{WEBSITE_URL}</a>, or our Products (the <strong>"Service"</strong>), whether as a guest or a registered user.</p>
	...
	<p>We may revise and update these Terms of Use from time to time in our sole discretion. All changes are effective immediately when we post them, and apply to all access to and use of the Service thereafter.</p>
	<p>Your continued use of the Service following the posting of revised Terms of Use means that you accept and agree to the changes. You are expected to check this page each time you access the Service so you are aware of any changes, as they are binding on you.</p>
	...
	<p>You are responsible for making all arrangements necessary for you to have access to the Service, and ensuring that all persons who access the Service through your internet connection are aware of these Terms of Use and comply with them.</p>
	<p>To access the Service or some of the resources it offers, you may be asked to provide certain registration details or other information. It is a condition of your use of the Service that all the information you provide on the Service is correct, current and complete. You agree that all information you provide to register with the Service or otherwise, including but not limited to through the use of any interactive features on the Service, is governed by our Privacy Policy, and you consent to all actions we take with respect to your information consistent with our Privacy Policy.</p>
	<p>If you choose, or are provided with, an email, password or any other piece of information as part of our security procedures, you must treat such information as confidential, and you must not disclose it to any other person or entity. You also acknowledge that your account is personal to you and agree not to provide any other person with access to the Service or portions of it using your user name, password or other security information (and if you do, you agree to be responsible for and to indemnify, defend and hold us harmless from any damages caused by any such person to whom you provide any such information). You agree to notify us immediately of any unauthorized access to or use of your user name or password or any other breach of security. You should use particular caution when accessing your account from a public or shared computer so that others are not able to view or record your password or other personal information.</p>
	...
	<p>The Service provided by {t.main.title} includes our video games, mobile and desktop applications, official websites, and related communication channels such as newsletters or mailing lists (collectively, the <strong>“Service”</strong>).</p>
	<p>The Service allows users to access, download, and interact with the creative works, features, and community elements developed and maintained by {t.main.title}. Depending on the specific product, users may be able to create, share, or submit certain materials such as gameplay data, feedback, or community contributions (“User Content”), subject to the terms described in this document.</p>
	<p>Unless otherwise stated, all games, software, websites, and related materials are owned or licensed by {t.main.title}. The Company does not claim ownership over any original User Content you create and share through the Service, but you grant the Company a non-exclusive, worldwide, royalty-free license to use, display, and distribute such User Content within the Service for its normal operation and promotion.</p>
	<p>You remain solely responsible for any and all content you submit or make available through the Service, and for ensuring that your use of the Service complies with applicable laws and these Terms. {t.main.title} does not assume liability for any User Content shared through its platforms.</p>
	<p>When you remove your User Content, it will no longer be publicly available through the Service; however, copies may remain in backups or may continue to be used by other users who previously accessed or downloaded it, in accordance with these Terms.</p>

	<h2>Intellectual Property Rights</h2>
	<p>The Service and its entire contents, features and functionality (including but not limited to all information, software, text, displays, images, video and audio, and the design, selection and arrangement thereof), are owned by the Company, its licensors or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret and other intellectual property or proprietary rights laws.</p>
	<p>These Terms of Use permit you to use the Service for your personal, non-commercial use only.</p>
	<p>No right, t.main.title or interest in or to the Service or any content contained therein is transferred to you, and all rights not expressly granted are reserved by the Company. Any use of the Service not expressly permitted by these Terms of Use is a breach of these Terms of Use and may violate copyright, trademark and other laws.</p>

	<h2>Trademarks</h2>
	<p>The Company name, the terms, {t.main.title}, the Company logo and all related names, logos, product and service names, designs and slogans are trademarks of the Company or its affiliates or licensors. You must not use such marks without the prior written permission of the Company. All other names, logos, product and service names, designs and slogans contained in the Service are the trademarks of their respective owners.</p>

	<h2>Prohibited Uses</h2>
	<p>You may use the Service only for lawful purposes and in accordance with these Terms of Use. You agree not to use the Service:</p>
	<ol>
	...
	<ol>
		...
		<li>Use any robot, spider or other automatic device, process or means to access the Service for any purpose, including monitoring or copying any of the material contained in the Service.</li>
		<li>Use any manual process to monitor or copy any of the material contained in the Service or for any other unauthorized purpose without our prior written consent.</li>
	...
	<p>The Service may contain message boards, chat rooms, personal web pages or profiles, forums, bulletin boards and other interactive features (collectively, <strong>"Interactive Services"</strong>) that allow users to post, submit, publish, display or transmit to other users or other persons (hereinafter, <strong>"post"</strong>) content or materials (collectively, <strong>"User Contributions"</strong>) on or through the Service.</p>
	<p>Any User Contribution you post to the site will be considered non-confidential and non-proprietary. By providing any User Contribution through the Service, you grant us and our affiliates and service providers, and each of their and our respective licensees, successors and assigns the right to use, reproduce, modify, perform, display, distribute and otherwise disclose to third parties any such material for any purpose consistent with your account settings.</p>
	...
	<p>We are not responsible, or liable to any third party, for the content or accuracy of any User Contributions posted by you or any other user of the Service.</p>
	...
	<p>We may update the content on the Service from time to time, but its content is not necessarily complete or up-to-date. Any of the material on the Service may be out of date at any given time, and we are under no obligation to update such material.</p>
	...
	<p>The owner of the Service is based in the city of Madrid in Spain. Access to the Service may not be legal by certain persons or in certain countries. If you access the Service from outside the European Economic Area (EEA), you do so on your own initiative and are responsible for compliance with local laws.</p>
	...
	<p>These Terms of Use and any dispute or claim arising out of or in connection with them or their subject matter shall be governed by and construed in accordance with the laws of the country in which {t.main.title} is established, without regard to its conflict of law principles.</p>
	<p>If you are a consumer residing in the European Economic Area (EEA), you may bring any dispute related to these Terms before the competent court of your place of residence or before the courts of the country in which {t.main.title} is established.</p>
	<p>At the Company’s discretion, and only if you agree, disputes may alternatively be resolved through an independent arbitration or mediation service, in accordance with the applicable laws of the EEA member state where you reside.</p>
	<p>{t.main.title} also informs consumers that they may submit complaints for online dispute resolution through the European Commission’s ODR platform, available at:
		<a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer">ec.europa.eu</a></p>
	...
	<p>All other feedback, comments, requests for technical support and other communications relating to the Service should be directed to: contact@losuperninis.com.</p>
</div>
...
<style>
    ...
    @media (min-width: 768px) {
        .page-t.main.title { font-size: 5rem; }
        .terms-content { padding: 4rem; }
    }
</style>